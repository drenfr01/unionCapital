...
var memberPhotoStore = new FS.Store.FileSystem("memberProfilePhotos", {
  maxTries: 1
});


MemberProfilePhotos = new FS.Collection("memberProfilePhotos", {
  stores: [memberPhotoStore]
});

MemberProfilePhotos.allow({
  insert: function(userId, doc) {
    return true;
  },
  update: function(userId, doc, fieldNames, modifier) {
