...
Template.partnerMembers.rendered = function() {
  MemberNameSearch.search("");
  highlightSortedColumn("#" + Session.get('sortOn'));
};

Template.partnerMembers.helpers({
  getMembers: function() {
...
Template.partnerMembers.events({
  ...
  'click .memberRow': function(e) {
    e.preventDefault();
    Router.go('viewPartnerMemberProfile', {_id: this.memberId});
  }
});
